...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250219165251_RefreshTokenItselfAsPrimaryKey")]
    partial class RefreshTokenItselfAsPrimaryKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.User.UserEmailConfirmationCode", b =>
                {
                    ...
                    b.ToTable("UserEmailConfirmationCodes", "Authentication");
                });

            modelBuilder.Entity("Domain.Models.User.UserPasswordResetCode", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("UserPasswordResetCodes", "Authentication");
                });

            modelBuilder.Entity("Domain.Models.User.UserRefreshToken", b =>
                {
                    ...
                    b.ToTable("UserRefreshTokens", "Authentication");
                });
            ...
            modelBuilder.Entity("Domain.Models.User.UserEmailConfirmationCode", b =>
                {
                    b.HasOne("Domain.Models.User.User", "User")
                        ...
                        .HasForeignKey("Domain.Models.User.UserEmailConfirmationCode", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Domain.Models.User.UserPasswordResetCode", b =>
                {
                    b.HasOne("Domain.Models.User.User", "User")
                        ...
                        .HasForeignKey("Domain.Models.User.UserPasswordResetCode", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
